        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingAddress_Building = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BillingAddress_Floor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BillingAddress_Apartment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PaymentSummary_Last4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
