...
namespace Commerce.Infrastructure.Migrations
{
    ...
    [Migration("20260919122306_AddWhishList")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commerce.Core.Entities.Coupons.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsSingleUsePerCustomer")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Commerce.Core.Entities.Coupons.CouponRedemption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CouponId", "BuyerEmail");
            ...
            modelBuilder.Entity("Commerce.Core.Entities.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Commerce.Core.Entities.Coupons.CouponRedemption", b =>
                {
                    b.HasOne("Commerce.Core.Entities.Coupons.Coupon", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Commerce.Core.Entities.WishlistItem", b =>
                {
                    b.HasOne("Commerce.Core.Entities.Products.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
